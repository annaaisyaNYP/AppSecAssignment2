...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     <script src="https://www.google.com/recaptcha/api.js?render=6LfUmUoaAAAAAPVVRabaw22BvgQkMw3kvZCvIIWW"></script>
    <h2>Login</h2>
    ...
    <script>
        grecaptcha.ready(function () {
            grecaptcha.execute('6LfUmUoaAAAAAPVVRabaw22BvgQkMw3kvZCvIIWW', { action: 'Login' }).then(function (token) {
